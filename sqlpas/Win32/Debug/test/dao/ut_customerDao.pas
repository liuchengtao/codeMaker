...
function TDao.add(entity: utcustomer): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utcustomer): TList<utcustomer>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
   entity1: utcustomer;
...
function TDao.getOneById(id: Integer): utcustomer;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utcustomer): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
