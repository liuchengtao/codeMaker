...
function TDao.add(entity: utpurchaselistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utpurchaselistgoods): TList<utpurchaselistgoods>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
...
function TDao.getOneById(id: Integer): utpurchaselistgoods;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utpurchaselistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
