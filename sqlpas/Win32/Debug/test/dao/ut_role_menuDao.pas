...
function TDao.add(entity: utrolemenu): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utrolemenu): TList<utrolemenu>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
   entity1: utrolemenu;
...
function TDao.getOneById(id: Integer): utrolemenu;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utrolemenu): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
