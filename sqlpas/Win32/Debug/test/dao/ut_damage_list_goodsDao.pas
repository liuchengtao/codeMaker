...
{ t_damage_list_goodsDao }

functiont_damage_list_goodsDao.add(entity: utdamagelistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
    sqlStr := 'insert into %0:S(%1:S) Values ({SQL_ADD_COL});';
    sqlStr := Format(sqlStr,[TABLE_NAME,TABLE_ADD_COL,entity.id,entity.code,entity.model,entity.name,entity.num,entity.price,entity.total,entity.unit,entity.damage_list_id,entity.type_id,entity.goods_id,]);
...
function t_damage_list_goodsDao.deleteById(id: Integer): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function t_damage_list_goodsDao.findList(entity: utdamagelistgoods): TList<utdamagelistgoods>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
...
function t_damage_list_goodsDao.getOneById(id: Integer): utdamagelistgoods;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function t_damage_list_goodsDao.updateById(entity: utdamagelistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
    sqlStr := 'update %0:S set {SQL_UPDATE_VALUE} where id = %1:D';
    sqlStr := Format(sqlStr,[TABLE_NAME,entity.id,entity.code,entity.model,entity.name,entity.num,entity.price,entity.total,entity.unit,entity.damage_list_id,entity.type_id,entity.goods_id,]);
    Result := BaseDM.ExecSQL(sqlStr);
  Except
    Result := -1;
  End;
