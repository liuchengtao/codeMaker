...
function TDao.add(entity: utcustomerreturnlistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utcustomerreturnlistgoods): TList<utcustomerreturnlistgoods>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
...
function TDao.getOneById(id: Integer): utcustomerreturnlistgoods;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utcustomerreturnlistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
