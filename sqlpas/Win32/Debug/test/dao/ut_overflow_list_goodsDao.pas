...
function TDao.add(entity: utoverflowlistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utoverflowlistgoods): TList<utoverflowlistgoods>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
...
function TDao.getOneById(id: Integer): utoverflowlistgoods;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utoverflowlistgoods): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
