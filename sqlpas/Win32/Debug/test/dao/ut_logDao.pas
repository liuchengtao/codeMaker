...
function TDao.add(entity: utlog): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utlog): TList<utlog>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
   entity1: utlog;
...
function TDao.getOneById(id: Integer): utlog;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utlog): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
