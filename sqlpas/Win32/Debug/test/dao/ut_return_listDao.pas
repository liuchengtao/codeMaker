...
function TDao.add(entity: utreturnlist): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
...
function TDao.findList(entity: utreturnlist): TList<utreturnlist>;
var wc: TWhereClause;
   sqlStr,wcStr: String;
   qry: TFDQuery;
...
function TDao.getOneById(id: Integer): utreturnlist;
var sqlStr: String;
   qry: TFDQuery;
begin
  New(Result);
...
function TDao.updateById(entity: utreturnlist): Integer;
var sqlStr: String;
begin
  Result := -1;
  Try
